...
public class RecordProcessedEventHandlingServiceImplTest extends AbstractRestTest {
  ...
  public void setUp() throws IOException {
    ...
    MappingMetadataService mappingMetadataService = new MappingMetadataServiceImpl(mappingParametersProvider, mappingRuleService, mappingRulesSnapshotDao, mappingParamsSnapshotDao, CACHE_EXPIRATION_TIME);
