...
public class AuthorityMappingFormSubdivisionCustomMigrationTest {

  private static final String TENANT_ID = "test";
  private static final String PATH = "src/test/resources/org/folio/mapping/formSubdivision/";

  private @Mock MappingRuleService mappingRuleService;
  private @InjectMocks AuthorityMappingFormSubdivisionCustomMigration migration;
  private @Captor ArgumentCaptor<String> rulesCaptor;

  @Test
  public void shouldAddFormSubdivisionFieldsToMarcAuthorityRules() throws IOException {
    var existedJson = readFileFromPath(PATH + "rulesAuthorityFormSubdivisionExisted.json");
    var expectedJson = readFileFromPath(PATH + "rulesAuthorityFormSubdivisionExpected.json");
