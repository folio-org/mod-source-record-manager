...
public class AuthorityMappingChronSubdivisionCustomMigrationTest {

  private static final String TENANT_ID = "test";
  private static final String PATH = "src/test/resources/org/folio/mapping/chronSubdivision/";

  private @Mock MappingRuleService mappingRuleService;
  private @InjectMocks AuthorityMappingChronSubdivisionCustomMigration migration;
  private @Captor ArgumentCaptor<String> rulesCaptor;

  @Test
  public void shouldAddChronSubdivisionFieldsToMarcAuthorityRules() throws IOException {
    var existedJson = readFileFromPath(PATH + "rulesAuthorityChronSubdivisionExisted.json");
    var expectedJson = readFileFromPath(PATH + "rulesAuthorityChronSubdivisionExpected.json");
