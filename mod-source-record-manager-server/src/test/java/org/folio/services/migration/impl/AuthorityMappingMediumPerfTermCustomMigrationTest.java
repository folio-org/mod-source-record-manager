...
public class AuthorityMappingMediumPerfTermCustomMigrationTest {

  private static final String TENANT_ID = "test";
  private static final String PATH = "src/test/resources/org/folio/mapping/mediumPerfTerm/";

  private @Mock MappingRuleService mappingRuleService;
  private @InjectMocks AuthorityMappingMediumPerfTermCustomMigration migration;
  private @Captor ArgumentCaptor<String> rulesCaptor;

  @Test
  public void shouldAddMediumPerfTermFieldsToMarcAuthorityRules() throws IOException {
    var existedJson = readFileFromPath(PATH + "rulesAuthorityMediumPerfTermExisted.json");
    var expectedJson = readFileFromPath(PATH + "rulesAuthorityMediumPerfTermExpected.json");
