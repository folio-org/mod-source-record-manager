...
public class AuthorityMappingIdentifierTypeCodeCustomMigrationTest {

  private static final String TENANT_ID = "test";
  private static final String PATH = "src/test/resources/org/folio/mapping/identifierTypeCode/";

  private @Mock MappingRuleService mappingRuleService;
  private @InjectMocks AuthorityMappingIdentifierTypeCodeCustomMigration migration;
  private @Captor ArgumentCaptor<String> rulesCaptor;

  @Test
  public void shouldUpdateIdentifierTypeConditionsToCodeBased() throws IOException {
    var existedJson = readFileFromPath(PATH + "rulesAuthorityIdentifierTypeCodeExisted.json");
    var expectedJson = readFileFromPath(PATH + "rulesAuthorityIdentifierTypeCodeExpected.json");
