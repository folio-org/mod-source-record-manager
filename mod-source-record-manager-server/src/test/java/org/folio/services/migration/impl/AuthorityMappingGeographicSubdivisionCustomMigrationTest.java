...
public class AuthorityMappingGeographicSubdivisionCustomMigrationTest {

  private static final String TENANT_ID = "test";
  private static final String PATH = "src/test/resources/org/folio/mapping/geographicSubdivision/";

  private @Mock MappingRuleService mappingRuleService;
  private @InjectMocks AuthorityMappingGeographicSubdivisionCustomMigration migration;
  private @Captor ArgumentCaptor<String> rulesCaptor;

  @Test
  public void shouldAddGeographicSubdivisionFieldsToMarcAuthorityRules() throws IOException {
    var existedJson = readFileFromPath(PATH + "rulesAuthorityGeographicSubdivisionExisted.json");
    var expectedJson = readFileFromPath(PATH + "rulesAuthorityGeographicSubdivisionExpected.json");
