...
public class ProfileSnapshotUtilTest {
  ...
  // ---------------------------------------------------------------------------
  // containsDelete999FieldMappingDetail
  // ---------------------------------------------------------------------------
...
//  @Test
  public void shouldReturnFalseIfMappingDetailsIsNull() {
    MappingProfile mappingProfile = new MappingProfile().withMappingDetails(null);
  ...
  // ---------------------------------------------------------------------------
  // containsDelete999FieldMarcMappingDetail
  // ---------------------------------------------------------------------------
...
//  @Test
  public void shouldReturnTrueIfMatchingDetailIsNotFirstElement() {
    MarcMappingDetail nonMatchingDetail = new MarcMappingDetail()
    ...
    assertTrue(ProfileSnapshotUtil.containsDelete999FieldMarcMappingDetail(
      List.of(nonMatchingDetail, delete999FieldMarcMappingDetail())));
  }
...
//  @Test
  public void shouldReturnFalseIfSubfieldsIsNull() {
    MarcMappingDetail detail = new MarcMappingDetail()
      .withAction(MarcMappingDetail.Action.DELETE)
      .withField(new MarcField()
        .withField(TAG_999)
