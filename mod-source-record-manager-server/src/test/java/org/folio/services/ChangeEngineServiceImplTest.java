...
public class ChangeEngineServiceImplTest {
  ...
  private static final String MARC_AUTHORITY_REC_EXISTING_WITHOUT_FF =
    "00602nz  a2200205n  4500001000900000005001700009008004100026010001700067035002100084035001500105035002200120040002300142053001500165150003500180550002400215550001600239667003800255670002400293999007900317\u001E11664738\u001E20251124155730.5\u001E860211 | anbnnbabn          |b ana      \u001E  \u001Fasj2021053664\u001E  \u001Fa(DLC)sh 85087063\u001E  \u001Fa(DLC)84102\u001E  \u001Fa(DLC)sj2021053664\u001E  \u001FaDLC\u001Fbeng\u001FcDLC\u001FdDLC\u001E 0\u001FaLB1029.M75\u001E  \u001FaMontessori method of education\u001E  \u001Fwg\u001FaKindergarten upd\u001E  \u001Fwg\u001FaTeaching\u001E  \u001FaMachine-derived authority record.\u001E  \u001FaTen red rods, 1980.\u001E00\u001Fs8c025415-e2b1-4fca-846e-23a7676210b2\u001Fi19a4f9f7-7f95-4519-a599-ba29aac00b4e\u001E\u001D";
  ...
  @Test
  public void shouldGenerateAuthorityIdWhenExisting999IndicatorsAreNotFF() {
    RawRecordsDto rawRecordsDto = getTestRawRecordsDto(MARC_AUTHORITY_REC_EXISTING_WITHOUT_FF);
    JobExecution jobExecution = getTestJobExecution();
    ...
    assertThat(actual.getFirst().getErrorRecord(), nullValue());
    assertThat(actual.getFirst().getExternalIdsHolder().getAuthorityId(), notNullValue());
    assertThat(actual.getFirst().getExternalIdsHolder().getAuthorityId(), not(equalTo("19a4f9f7-7f95-4519-a599-ba29aac00b4e")));
    assertThat(actual.getFirst().getExternalIdsHolder().getAuthorityHrid(), notNullValue());
  }
  ...
  @Test
  public void shouldNotUse999ByAcceptInstanceIdWhenIndicatorsAreNotFF() {
    RawRecordsDto rawRecordsDto = getTestRawRecordsDto(MARC_BIB_REC_WITHOUT_FF);
    JobExecution jobExecution = new JobExecution()
      .withId(UUID.randomUUID().toString())
      .withUserId(UUID.randomUUID().toString())
    ...
    assertThat(actual.getFirst().getErrorRecord(), nullValue());
    assertThat(actual.getFirst().getMatchedId(), nullValue());
    assertThat(actual.getFirst().getExternalIdsHolder(), nullValue());
  }
