...
public class JournalParams {
  ...
  public enum JournalParamsEnum implements IJournalParams {
    ...
    DI_INCOMING_MARC_BIB_FOR_ORDER_PARSED {
      @Override
      public Optional<JournalParams> getJournalParams(DataImportEventPayload eventPayload) {
        return Optional.of(new JournalParams(CREATE,
    ...
    DI_INCOMING_EDIFACT_RECORD_PARSED {
      @Override
      public Optional<JournalParams> getJournalParams(DataImportEventPayload eventPayload) {
        return Optional.of(new JournalParams(CREATE,
          JournalRecord.EntityType.EDIFACT,
          JournalRecord.ActionStatus.COMPLETED));
      }
    },
    ...
    DI_PENDING_ORDER_CREATED {
      ...
      public Optional<JournalParams> getJournalParams(DataImportEventPayload eventPayload) {
        return Optional.of(
          new JournalParams(CREATE, JournalRecord.EntityType.PO_LINE, JournalRecord.ActionStatus.COMPLETED));
      }
    },
